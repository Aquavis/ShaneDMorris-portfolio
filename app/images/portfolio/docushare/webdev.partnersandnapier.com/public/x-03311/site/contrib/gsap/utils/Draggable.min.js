...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(a, b, c) {
            var d, e, f, g, h, i, j, k, l = {
                ...
                V = function(a, b) {
                    Ja(a, "scroll", b), X(a.parentNode) || V(a.parentNode, b)
                },
                W = function(a, b) {
                    Ka(a, "scroll", b), X(a.parentNode) || W(a.parentNode, b)
                },
                X = function(a) {
                ...
                Y = function(a, b) {
                    var c = "x" === b ? "Width" : "Height",
                        ...
                        e = "client" + c,
                        f = t.body;
                    return Math.max(0, X(a) ? Math.max(u[d], f[d]) - (window["inner" + c] || u[e] || f[e]) : a[d] - a[e])
                },
                Z = function(a) {
                    var b = X(a),
                        c = Y(a, "x"),
                ...
                $ = function(a, b) {
                    return a = a || window.event, q.pageX = a.clientX + t.body.scrollLeft + u.scrollLeft, q.pageY = a.clientY + t.body.scrollTop + u.scrollTop, b && (a.returnValue = !1), q
                },
                _ = function(a) {
                ...
                ca = ("undefined" != typeof window ? window : t.defaultView || {
                    getComputedStyle: function() {}
                }).getComputedStyle,
                da = function(a, b) {
                    return ca(a instanceof Element ? a : a.host || (a.parentNode || {}).host || a, b)
                },
                ...
                ia = function(a, b, c) {
                    ...
                    return e || 0 === e ? e : (a.style && a.style[b] ? e = a.style[b] : (d = da(a)) ? (e = d.getPropertyValue(b.replace(/([A-Z])/g, "-$1").toLowerCase()), e = e || d.length ? e : d[b]) : a.currentStyle && (e = a.currentStyle[b]), "auto" !== e || "top" !== b && "left" !== b || (e = ha(a, b)), c ? e : parseFloat(e) || 0)
                },
                ja = function(a, b, c) {
                    var d = a.vars,
                        e = d[c],
                ...
                ma = "" !== aa(w, "perspective"),
                na = aa(w, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
                oa = aa(w, "transform"),
                ...
                ua = _gsScope.navigator && (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(_gsScope.navigator.userAgent) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(_gsScope.navigator.userAgent)) && parseFloat(RegExp.$1) < 11,
                va = [],
                wa = [],
                xa = function(a) {
                    ...
                    for (d = e.getBoundingClientRect(), j = a.getScreenCTM(), m = a.createSVGPoint(), l = m.matrixTransform(j), s.scaleX = Math.sqrt(j.a * j.a + j.b * j.b), s.scaleY = Math.sqrt(j.d * j.d + j.c * j.c), void 0 === g && la(), s.borderBox && !h && a.getAttribute("width") && (f = da(a) || {}, n = parseFloat(f.borderLeftWidth) + parseFloat(f.borderRightWidth) || 0, o = parseFloat(f.borderTopWidth) + parseFloat(f.borderBottomWidth) || 0, p = parseFloat(f.width) || 0, q = parseFloat(f.height) || 0, s.scaleX *= (p - n) / p, s.scaleY *= (q - o) / q), i ? (c = a.getBoundingClientRect(), s.offsetLeft = c.left - d.left, s.offsetTop = c.top - d.top) : (s.offsetLeft = l.x - d.left, s.offsetTop = l.y - d.top), s.offsetParent = e, k = wa.length; --k > -1;) wa[k].style[oa] = va[k];
                    return s
                },
                ya = function(a, c) {
                ...
                Ea = function(a, b, c) {
                    ...
                    b = _(b);
                    var d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, v, w, x, y, z, A, C = a.getBBox && ta(a);
                    if (a === window) g = T(), e = U(), f = e + (u.clientWidth || a.innerWidth || t.body.clientWidth || 0), h = g + ((a.innerHeight || 0) - 20 < u.clientHeight ? u.clientHeight : a.innerHeight || t.body.clientHeight || 0);
                    else {
                        if (void 0 === b || b === window) return a.getBoundingClientRect();
                        d = ya(a), e = -d.x, g = -d.y, C ? (o = a.getBBox(), p = o.width, q = o.height) : "svg" !== (a.nodeName + "").toLowerCase() && a.offsetWidth ? (p = a.offsetWidth, q = a.offsetHeight) : (z = da(a), p = parseFloat(z.width), q = parseFloat(z.height)), f = e + p, h = g + q, "svg" !== a.nodeName.toLowerCase() || B || (r = xa(a), A = r.computedStyle || {}, w = (a.getAttribute("viewBox") || "0 0").split(" "), x = parseFloat(w[0]), y = parseFloat(w[1]), s = parseFloat(A.borderLeftWidth) || 0, v = parseFloat(A.borderTopWidth) || 0, f -= p - (p - s) / r.scaleX - x, h -= q - (q - v) / r.scaleY - y, e -= s / r.scaleX - x, g -= v / r.scaleY - y, z && (f += (parseFloat(A.borderRightWidth) + s) / r.scaleX, h += (v + parseFloat(A.borderBottomWidth)) / r.scaleY))
                    }
                    return a === b ? {
                        left: e,
                        top: g,
                        ...
                        x: e,
                        y: h
                    }, i, j), e = Math.min(k.x, l.x, m.x, n.x), g = Math.min(k.y, l.y, m.y, n.y), K.x = K.y = 0, c && ya(b, K), {
                        left: e + K.x,
                        top: g + K.y,
                ...
                Ha = "undefined" != typeof window && "ontouchstart" in u && "orientation" in window,
                Ia = function(a) {
                ...
                Ma = function(a) {
                    e = a.touches && H < a.touches.length, Ka(a.target, "touchend", Ma)
                },
                Na = function(a) {
                    e = a.touches && H < a.touches.length, Ja(a.target, "touchend", Ma)
                },
                ...
                Pa = function(a) {
                    var b;
                    return a && a.getAttribute && "BODY" !== a.nodeName ? "true" === (b = a.getAttribute("data-clickable")) || "false" !== b && (a.onclick || G.test(a.nodeName + "") || "true" === a.getAttribute("contentEditable")) ? !0 : Pa(a.parentNode) : !1
                },
                Qa = function(a, b) {
                    for (var c, d = a.length; --d > -1;) c = a[d], c.ondragstart = c.onselectstart = b ? null : r, ba(c, "userSelect", b ? "text" : "none")
                },
                Ra = function() {
                ...
                Sa = function(a, c) {
                    ...
                    ma && c.force3D !== !1 ? (h = "translate3d(", i = "px,0px)") : oa && (h = "translate(", i = "px)"), this.scrollTop = function(a, b) {
                        ...
                        return (f > 2 || -2 > f) && !e ? (p = a.scrollLeft, b.killTweensOf(this, !0, {
                            left: 1,
                            scrollLeft: 1
                        }), this.left(-p), void(c.onKill && c.onKill())) : (d = -d, 0 > d ? (n = d - .5 | 0, d = 0) : d > u ? (n = d - u | 0, d = u) : n = 0, (n || g) && (h ? this._suspendTransforms || (k[oa] = h + -n + "px," + -m + i) : k.left = -n + "px", n + s >= 0 && (k.paddingRight = n + s + "px")), a.scrollLeft = 0 | d, void(p = a.scrollLeft))
                        ...
                        return (f > 2 || -2 > f) && !e ? (o = a.scrollTop, b.killTweensOf(this, !0, {
                            top: 1,
                            scrollTop: 1
                        }), this.top(-o), void(c.onKill && c.onKill())) : (d = -d, 0 > d ? (m = d - .5 | 0, d = 0) : d > v ? (m = d - v | 0, d = v) : m = 0, (m || g) && (h ? this._suspendTransforms || (k[oa] = h + -n + "px," + -m + i) : k.top = -m + "px"), a.scrollTop = 0 | d, void(o = a.scrollTop))
                ...
                Ta = function(d, g) {
                    ...
                    var h, i, j, k, q, r, s, v, w, D, G, O, R, T, U, Y, aa, ca, da, ea, fa, ga, ha, la, ma, na, oa, pa, qa, ra, sa, ua, va, wa, xa = (g.type || (B ? "top,left" : "x,y")).toLowerCase(),
                        ...
                        ib = function(a, b) {
                            ...
                            }, Math.max(g.minDuration || 0, g.maxDuration || 0) || 2, isNaN(g.minDuration) ? 0 === j || "object" == typeof a && a.resistance > 1e3 ? 0 : .5 : g.minDuration, j), g.fastMode || (i && (i._suspendTransforms = !0), h.render(h.duration(), !0, !0), eb(!0, !0), Ma.endX = Ma.x, Ma.endY = Ma.y, za && (Ma.endRotation = Ma.x), h.play(0), eb(!0, !0), i && (i._suspendTransforms = !1))) : s && Ma.applyBounds()
                        },
                        jb = function(a) {
                        ...
                        kb = function() {
                            ...
                            jb(!1), ma && (j = Ma.pointerX * ma[0] + Ma.pointerY * ma[2] + ma[4], k = Ma.pointerX * ma[1] + Ma.pointerY * ma[3] + ma[5]), ca && (rb(Ma.pointerX, Ma.pointerY), db(!0)), i ? (fb(), r = i.top(), q = i.left()) : (lb() ? (eb(!0, !0), fb()) : Ma.applyBounds(), za ? (aa = Ma.rotationOrigin = Ca(d, {
                                x: 0,
                                y: 0
                            }), eb(!0, !0), q = Ma.x, r = Ma.y = Math.atan2(aa.y - Ma.pointerY, Ma.pointerX - aa.x) * y) : (oa = d.parentNode ? d.parentNode.scrollTop || 0 : 0, pa = d.parentNode ? d.parentNode.scrollLeft || 0 : 0, r = ia(d, Da), q = ia(d, Aa))), s && a && (q > w ? q = w + (q - w) / a : D > q && (q = D - (D - q) / a), za || (r > G ? r = G + (r - G) / a : O > r && (r = O - (O - r) / a))), Ma.startX = q, Ma.startY = r
                        },
                        lb = function() {
                            return Ma.tween && Ma.tween.isActive()
                        },
                        mb = function() {
                            !C.parentNode || lb() || Ma.isDragging || C.parentNode.removeChild(C)
                        },
                        nb = function(a, b, c, d) {
                        ...
                        ob = function(a, b, c, d, e, f, g) {
                            return f = f && z > f ? f * f : z, "function" == typeof a ? function(h) {
                                var i, j, k, l = Ma.isPressed ? 1 - Ma.edgeResistance : 1,
                                    m = h.x,
                                    n = h.y;
                                return h.x = m = m > c ? c + (m - c) * l : b > m ? b + (m - b) * l : m, h.y = n = n > e ? e + (n - e) * l : d > n ? d + (n - d) * l : n, i = a.call(Ma, h), i !== h && (h.x = i.x, h.y = i.y), 1 !== g && (h.x *= g, h.y *= g), z > f && (j = h.x - m, k = h.y - n, j * j + k * k > f && (h.x = m, h.y = n)), h
                        ...
                        pb = function(a, c) {
                            ...
                            if (h && !Ma.isPressed && a && ("mousedown" !== a.type && "pointerdown" !== a.type || c || !(A() - bb < 30) || !Ia[Ma.pointerEvent.type])) {
                                ...
                                if (ra = !la || Ea === Fa || Ma.vars.allowNativeTouchScrolling === !1 || Ma.vars.allowContextMenu && a && (a.ctrlKey || a.which > 2) ? !1 : Ea ? "y" : "x", B ? a = $(a, !0) : ra || Ma.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = U = a.changedTouches[0], Y = a.identifier) : a.pointerId ? Y = a.pointerId : U = Y = null, H++, P(db), k = Ma.pointerY = a.pageY, j = Ma.pointerX = a.pageX, ja(Ma, "pressInit", "onPressInit"), (ra || Ma.autoScroll) && Z(d.parentNode), !d.parentNode || !Ma.autoScroll || i || za || !d.parentNode._gsMaxScrollX || C.parentNode || d.getBBox || (C.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(C)), kb(), Ma.tween && Ma.tween.kill(), Ma.isThrowing = !1, b.killTweensOf(i || d, !0, Ua), i && b.killTweensOf(d, !0, {
                                    ...
                                    for (e = Ra.length; --e > -1;) ba(Ra[e], "cursor", g.cursor || "move");
                                ja(Ma, "press", "onPress")
                            }
                        },
                        qb = function(a) {
                            ...
                            if (h && !e && Ma.isPressed && a) {
                                ...
                                if (B) a = $(a, !0);
                                    ...
                                    if (la && ra && !sa && (c = a.pageX, d = a.pageY, ma && (f = c * ma[0] + d * ma[2] + ma[4], d = c * ma[1] + d * ma[3] + ma[5], c = f), g = Math.abs(c - j), i = Math.abs(d - k), (g !== i && (g > Ga || i > Ga) || I && ra === sa) && (sa = g > i && Ea ? "x" : "y", Ma.vars.lockAxisOnTouchScroll !== !1 && (Ma.lockedAxis = "x" === sa ? "y" : "x", "function" == typeof Ma.vars.onLockAxis && Ma.vars.onLockAxis.call(Ma, l)), I && ra === sa))) return void sb(l);
                        ...
                        rb = function(a, b) {
                            var c, d, e, f, g, h, i = 1 - Ma.dragResistance,
                                l = 1 - Ma.edgeResistance;
                            Ma.pointerX = a, Ma.pointerY = b, za ? (f = Math.atan2(aa.y - b, a - aa.x) * y, g = Ma.y - f, g > 180 ? (r -= 360, Ma.y = f) : -180 > g && (r += 360, Ma.y = f), Ma.x !== q || Math.abs(r - f) > Ga ? (Ma.y = f, e = q + (r - f) * i) : e = q) : (ma && (h = a * ma[0] + b * ma[2] + ma[4], b = a * ma[1] + b * ma[3] + ma[5], a = h), d = b - k, c = a - j, Ga > d && d > -Ga && (d = 0), Ga > c && c > -Ga && (c = 0), (Ma.lockAxis || Ma.lockedAxis) && (c || d) && (h = Ma.lockedAxis, h || (Ma.lockedAxis = h = Ea && Math.abs(c) > Math.abs(d) ? "y" : Fa ? "x" : null, h && "function" == typeof Ma.vars.onLockAxis && Ma.vars.onLockAxis.call(Ma, Ma.pointerEvent)), "y" === h ? d = 0 : "x" === h && (c = 0)), e = q + c * i, f = r + d * i), (ea || fa || ga) && (Ma.x !== e || Ma.y !== f && !za) ? (ga && (K.x = e, K.y = f, h = ga(K), e = h.x, f = h.y), ea && (e = ea(e)), fa && (f = fa(f))) : s && (e > w ? e = w + (e - w) * l : D > e && (e = D + (e - D) * l), za || (f > G ? f = G + (f - G) * l : O > f && (f = O + (f - O) * l))), za || ma || (e = Math.round(e), f = Math.round(f)), (Ma.x !== e || Ma.y !== f && !za) && (za ? (Ma.endRotation = Ma.x = Ma.endX = e, ca = !0) : (Fa && (Ma.y = Ma.endY = f, ca = !0), Ea && (Ma.x = Ma.endX = e, ca = !0)), !Ma.isDragging && Ma.isPressed && (Ma.isDragging = !0, ja(Ma, "dragstart", "onDragStart")))
                        },
                        sb = function(a, c) {
                            if (h && Ma.isPressed && (!a || null == Y || c || !(a.pointerId && a.pointerId !== Y || a.changedTouches && !La(a.changedTouches, Y)))) {
                                Ma.isPressed = !1;
                                var e, f, i, j, k, l = a,
                                    m = Ma.isDragging,
                                    n = Ma.vars.allowContextMenu && a && (a.ctrlKey || a.which > 2),
                                    o = b.delayedCall(.001, mb);
                                if (la ? (Ka(la, "touchend", sb), Ka(la, "touchmove", qb), Ka(la, "touchcancel", sb), Ka(t, "touchstart", Na)) : Ka(t, "mousemove", qb), Ka(t, "mouseup", sb), a && a.target && Ka(a.target, "mouseup", sb), ca = !1, ha && !n) return a && (Ka(a.target, "change", sb), Ma.pointerEvent = l), Qa(Ra, !1), ja(Ma, "release", "onRelease"), ja(Ma, "click", "onClick"), void(ha = !1);
                                if (Q(db), !za)
                                    for (f = Ra.length; --f > -1;) ba(Ra[f], "cursor", g.cursor || "move");
                                if (m && (Va = J = A(), Ma.isDragging = !1), H--, a) {
                                ...
                                }, I || l.defaultPrevented || b.delayedCall(1e-5, k))) : (ib(g.throwProps), B || Ma.allowEventDefault || !l || !g.dragClickables && ab.call(Ma, l.target) || !m || ra && (!sa || ra !== sa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation()), ja(Ma, "release", "onRelease")), lb() && o.duration(Ma.tween.duration()), m && ja(Ma, "dragend", "onDragEnd"), !0
                            }
                        },
                        tb = function(a) {
                        ...
                        ub = function(a) {
                            ...
                            return f && (e || d && Ma.vars.suppressClickOnDrag !== !1) && a.stopImmediatePropagation(), !c || Ma.pointerEvent && Ma.pointerEvent.defaultPrevented || e && i === h ? void((Ma.isPressed || d || c) && (f ? i && a.detail && c && !g || (a.preventDefault(), a.preventManipulation && a.preventManipulation()) : a.returnValue = !1)) : (i && e && (wa = bb),
                                void(va = bb))
                        },
                        vb = function(a) {
                            return ma ? {
                    ...
                    da = Ta.get(this.target), da && da.kill(), this.startDrag = function(a, b) {
                        ...
                        pb(a || Ma.pointerEvent, !0), b && !Ma.hitTest(a || Ma.pointerEvent) && (c = Xa(a || Ma.pointerEvent), e = Xa(d), f = vb({
                            ...
                            x: e.left + e.width / 2,
                            y: e.top + e.height / 2
                        }), j -= f.x - g.x, k -= f.y - g.y), Ma.isDragging || (Ma.isDragging = !0, ja(Ma, "dragstart", "onDragStart"))
                    }, this.drag = qb, this.endDrag = function(a) {
                        sb(a || Ma.pointerEvent, !0)
                    }, this.timeSinceDrag = function() {
                        return Ma.isDragging ? 0 : (A() - Va) / 1e3
                        ...
                        return "element" === j && (h = Xa(Ma.target), i = Xa(a)), c = "start" === j ? Ma.x - q : "velocity" === j ? f.getVelocity(this.target, Aa) : h.left + h.width / 2 - (i.left + i.width / 2), za ? 0 > c ? "counter-clockwise" : "clockwise" : (b = b || 2, d = "start" === j ? Ma.y - r : "velocity" === j ? f.getVelocity(this.target, Da) : h.top + h.height / 2 - (i.top + i.height / 2), e = Math.abs(c / d), g = 1 / b > e ? "" : 0 > c ? "left" : "right", b > e && ("" !== g && (g += "-"), g += 0 > d ? "up" : "down"), g)
                    }, this.applyBounds = function(a) {
                        var b, c, e, f, h, i;
                        if (a && g.bounds !== a) return g.bounds = a, Ma.update(!0);
                        if (eb(!0), fb(), s) {
                            if (b = Ma.x, c = Ma.y, b > w ? b = w : D > b && (b = D), c > G ? c = G : O > c && (c = O), (Ma.x !== b || Ma.y !== c) && (e = !0, Ma.x = Ma.endX = b, za ? Ma.endRotation = b : Ma.y = Ma.endY = c, ca = !0, db(!0), Ma.autoScroll && !Ma.isDragging))
                            ...
                            Ma.isThrowing && (e || Ma.endX > w || Ma.endX < D || Ma.endY > G || Ma.endY < O) && ib(g.throwProps, e)
                        }
                        return Ma
                    }, this.update = function(a, b, c) {
                        var e = Ma.x,
                            f = Ma.y;
                        return jb(!b), a ? Ma.applyBounds() : (ca && c && db(!0), eb(!0)), b && (rb(Ma.pointerX, Ma.pointerY), ca && db(!0)), Ma.isPressed && !b && (Ea && Math.abs(e - Ma.x) > .01 || Fa && Math.abs(f - Ma.y) > .01 && !za) && kb(), Ma.autoScroll && (Z(d.parentNode), Wa = Ma.isDragging, db(!0)), Ma.autoScroll && (W(d, tb), V(d, tb)), Ma
                    }, this.enable = function(a) {
                        var e, j, k;
                        if ("soft" !== a) {
                            for (j = Ra.length; --j > -1;) k = Ra[j], Ja(k, "mousedown", pb), Ja(k, "touchstart", pb), Ja(k, "click", ub, !0), za || ba(k, "cursor", g.cursor || "move"), ba(k, "touchCallout", "none"), ba(k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), ta(k) && ba(k.ownerSVGElement || k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), this.vars.allowContextMenu || Ja(k, "contextmenu", cb);
                            Qa(Ra, !1)
                        }
                        ...
                        if (!za)
                            for (b = Ra.length; --b > -1;) ba(Ra[b], "cursor", null);
                        if ("soft" !== a) {
                            for (b = Ra.length; --b > -1;) c = Ra[b], ba(c, "touchCallout", null), ba(c, "touchAction", null), Ka(c, "mousedown", pb), Ka(c, "touchstart", pb), Ka(c, "click", ub), Ka(c, "contextmenu", cb);
                            Qa(Ra, !0), la && (Ka(la, "touchcancel", sb), Ka(la, "touchend", sb), Ka(la, "touchmove", qb)), Ka(t, "mouseup", sb), Ka(t, "mousemove", qb)
                        }
                        return W(d, tb), h = !1, f && "soft" !== a && f.untrack(i || d, ya ? "x,y" : za ? "rotation" : "top,left"), i && i.disable(), Q(db), Ma.isDragging = Ma.isPressed = ha = !1, e && ja(Ma, "dragend", "onDragEnd"), Ma
                    }, this.enabled = function(a, b) {
                        return arguments.length ? a ? Ma.enable(b) : Ma.disable(b) : h
                    }, this.kill = function() {
                        return Ma.isThrowing = !1, b.killTweensOf(i || d, !0, Ua), Ma.disable(), b.set(Ra, {
                            clearProps: "userSelect"
                        }), delete E[d._gsDragID], Ma
                    }, -1 !== xa.indexOf("scroll") && (i = this.scrollProxy = new Sa(d, S({
                        onKill: function() {
                        ...
                        force3D: !0
                    }), za ? Ua.rotation = 1 : (Ea && (Ua[Aa] = 1), Fa && (Ua[Da] = 1)), za ? (R = o, T = R.css, R.overwrite = !1) : ya && (R = Ea && Fa ? l : Ea ? m : n, T = R.css, R.overwrite = !1), this.enable()
                },
                Ua = Ta.prototype = new a;
            Ua.constructor = Ta, Ua.pointerX = Ua.pointerY = Ua.startX = Ua.startY = Ua.deltaX = Ua.deltaY = 0, Ua.isDragging = Ua.isPressed = !1, Ta.version = "0.16.5", Ta.zIndex = 1e3, Ja(t, "touchcancel", function() {}), Ja(t, "contextmenu", function(a) {
                var b;
            ...
            var Va = {},
                ...
                Xa = function(a, b) {
                    ...
                    var c = a.pageX !== b ? {
                        ...
                        right: a.pageX - U() + 1,
                        bottom: a.pageY - T() + 1
                    } : a.nodeType || a.left === b || a.top === b ? B ? Wa(a) : _(a).getBoundingClientRect() : a;
            ...
            }, C.style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;", Ta
        }, !0)
